...
if __name__ == '__main__':
    ...
    if os.path.exists(processed_data_path):
        ...
        dataset = DataSet(train_src=['train.json.shard1','train.json.shard2','train.json.shard3','train.json.shard4','train.json.shard5'],
                          valid_src=None,
                          test_src=['xen.json.shard1', 'xen.json.shard2'],
